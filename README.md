...
<!-- download:start -->
### [⬇︎ Download Softcap 0.1.5](https://github.com/milushov/softcap/releases/latest/download/Softcap.dmg)

A disk image for macOS 14 and later. Released 13 September 2026 — [all versions](https://github.com/milushov/softcap/releases/tag/v0.1.5).
<!-- download:end -->
