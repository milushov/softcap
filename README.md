...
<!-- download:start -->
### [⬇︎ Download Softcap 0.1.42](https://github.com/milushov/softcap/releases/latest/download/Softcap.dmg)

A disk image for macOS 14 and later. Released 26 September 2026 — [all versions](https://github.com/milushov/softcap/releases/tag/v0.1.42).
<!-- download:end -->
...
Copilot, the GLM Coding Plan and Kimi Code are implemented — a device grant and
two keys typed in — and none has been checked against a live subscription, so
none is offered as supported.
